...
final class AdminControlsSpec
{
     ...
     * be unioned in regardless of what the merchant types, or the custom
     * field becomes a bypass for the backend available_terms restriction
     * (TWO-24813) - a real business/credit-risk control, not just a UI
     * narrowing. 99 is not in PAYMENT_TERMS_OPTIONS (the fallback source on a
     * cold cache) at all.
     */
