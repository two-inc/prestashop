/**
 * Ruling 19.5: a brand overlay may reword the DECLINED order-intent notice or
 * suppress it entirely, on the same two keys the approved notice has carried
 * since TWO-25218. Suppression hides the text only - the order-prevention gate
 * it accompanies is functional and stays armed.
 */
